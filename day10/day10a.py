...
has a score of 1 because it can reach a single 9 (the one in the bottom left).
    ...
    ...1...             ...1.98             2...8..
    ...2...             ...2..7             3...7..
    6543456             6543456             4567654
    7.....7             765.987             ...8..3
    8.....8             876....             ...9..2
    9.....9             987....             .....01
    
(The positions marked . are impassable tiles to simplify these examples; they don't appear on your actual map.)
A) This trailhead has a score of 2.
B) This trailhead has a score of 4 because every 9 is reachable via a hiking trail except the one 
   immediately to the left of the trailhead.
C) This topographic map contains two trailheads; the trailhead at the top has a score of 1, while 
